...
{
	shapeFile = "Add-Ons/Server_Power/shapes/primitives/cube/cube_glow.dts";
};
...
{
	shapeFile = "Add-Ons/Server_Power/shapes/primitives/cone/cone_glow.dts";
};
...
{
	shapeFile = "Add-Ons/Server_Power/shapes/primitives/cylinder/cylinder_glow.dts";
};
